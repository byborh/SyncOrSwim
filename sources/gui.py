...
if __name__ == "__main__":
    ...
    add_plot_entry(analyses_widgets["ROLLINGORDER"]["show_button"]      , "Rolling order stats : bar graph (highlight #1-3)", lambda: ENGINE.drawRollingOrderStats(3) , engine.PLOTS["ROLLINGORDERBAR"])
    add_plot_entry(analyses_widgets["ROLLINGORDER"]["show_button"]      , "Rolling order stats : pie graph"                 , lambda: ENGINE.drawRollingOrderStats(4) , engine.PLOTS["ROLLINGORDERPIE"])
    add_plot_entry(analyses_widgets["ROLLINGORDER"]["show_button"]      , "Rolling order stats : pie graph (highlight #1)"  , lambda: ENGINE.drawRollingOrderStats(5) , engine.PLOTS["ROLLINGORDERPIE"])
